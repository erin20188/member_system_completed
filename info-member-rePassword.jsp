...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
    ...
    <a href="#" class="active"><li class="nav-item" id="rePassword"><i class="icon-lock"></i><span>修改密码</span></li></a>
    ...
    <div class="form-group">
    <label>新密码</label>
    <input type="password" class="form-control" name="newPwd" id="newPwd" placeholder="设置6到16位的密码"/>
    </div>
    <div class="form-group">
    <label>确认密码</label>
    ...
    <div class="form-group">
    <button class="btn btn-primary btn-block" name="rePassword-btn" id="rePassword-btn" type="submit">修改密码</button>
    </div>
    </form>
    </div>
    </div>
