...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
    ...
    <a href="#" class="active"><li class="nav-item" id="comment"><i class="icon-comments-alt"></i><span>我的评价</span></li></a>
    <a href="info-member-feedback.jsp"><li class="nav-item" id="feedback"><i class=" icon-edit"></i><span>意见反馈</span></li></a>
    </div>
    <div class="col-md-10">
    <div id="commentPage">
    <div class="title btm-line">我的评价：</div>
    <p class="shop-name"><%=request.getParameter("compName")%></p>
    <form action="memberReviewServlet" method="post">
        <%session.setAttribute("compName",request.getParameter("compName")); %>
    <textarea id="comment-item" placeholder="亲，环境怎么样，服务满意吗？" name="comment-item"></textarea>
    <button class="btn btn-primary" type="submit" id="feedback-btn">提交点评</button>
    </form>
    </div>
    </div>
    </div>
