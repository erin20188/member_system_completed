...
<div>
    ...
    <div class="container container-sm">
        <div class="search-bar">
            <div class="nav1">
                <span><a href="#">当前所在城市：成都</a></span>
                <span class="path">></span>
                <span><a href="#">锦江区</a></span>
                <span class="path">></span>
                <span><a href="#">春熙路</a></span>
            </div>
            <div class="content">
                <div class="classify nav nav-tabs" id="classify">
                    <h4>分类</h4>
                    <a href="search.jsp" id="all-cf"><span>不限</span></a>
                    <div class="cf-container">
                        <a href="search-hotel.jsp" id="hotel"><span>酒店</span></a>
                        <a href="search-food.jsp" id="food"><span>美食</span></a>
                        <a href="search-shopping.jsp" id="shopping"><span>购物</span></a>
                        <a href="search-entertain.jsp" id="entertain"><span>休闲娱乐</span></a>
                        <a href="search-travel.jsp" id="travel"><span>周边游</span></a>
                    </div>
                </div>
                <div class="search-info row">
                    ...
                    <div class="col-md-2">
                        <div class="list">
                            <span>你可能会喜欢</span>
                            <div class="item">
                                <a href="#"><img src="img/shop-ylhg.jpg" alt="商家照片-s"/></a>
                                <div class="name"><a href="#" onclick="ulrHtml('娱乐画馆');">娱乐画馆</a></div>
                                <div class="desc">
                                    武侯区  | 休闲娱乐</div>
                            </div>
                            <div class="item">
                                <a href="#"><img src="img/shop-rrz.jpg" alt="商家照片-s"/></a>
                                <div class="name"><a href="#" onclick="ulrHtml('日日煮美食体验馆');">日日煮美食体验馆</a></div>
                                <div class="desc">
                                    武侯区  | 休闲娱乐</div>
                            </div>
                            <div class="item">
                                <a href="#"><img src="img/shop-med.jpg" alt="商家照片-s"/></a>
                                <div class="name"><a href="#" onclick="ulrHtml('马尔代');">马尔代</a></div>
                                <div class="desc">
                                    双流区  | 美食</div>
                            </div>
                            <div class="item">
                                <a href="#"><img src="img/shop-panda.png" alt="乡村基照片"/></a>
                                <div class="name"><a href="#" onclick="ulrHtml('大熊猫繁育研究基地');">大熊猫繁育研究基地</a></div>
                                <div class="desc">
                                    新都区  | 周边游</div>
                            </div>
                        </div>
...
<script src="js/search-res.js"></script>
