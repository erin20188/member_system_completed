...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
    ...
    <a href="#" class="active"><li class="nav-item" id="feedback"><i class=" icon-edit"></i><span>意见反馈</span></li></a>
    </div>
    <div class="col-md-10">
    <div id="feedbackPage">
    <div class="title btm-line">意见反馈：</div>
    <form action="addAdviceServlet" method="post">
    <textarea id="feedback-content" placeholder="欢迎提出对本平台的宝贵建议或问题反馈" name="feedback-content"></textarea>
    <button class="btn btn-primary" type="submit" id="feedback-btn">提交反馈信息</button>
    </form>
    </div>
    </div>
    </div>
