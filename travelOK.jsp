<%@ page language="java" import="java.util.*,com.qicaiyun.beans.TravelProduct" pageEncoding="UTF-8"
	errorPage="error.jsp"%>
...
function TUpd(obj1, obj2) {
	...
	window.location = "1-travelPro.jsp?id="+id;
}
function TDel(obj1, obj2) {
	var id;
    id = document.getElementById("jspTID_" + obj1).value;
	window.location = "deletetravelproductServlet?id=" + id ;
}
            ...
            <div class="row">
                ...
                <div id="mContent" class="col-r">
                    ...
                    <div id="mProductpage" name="mProductpage">
                        <a href="add-travelPro.html"><input type="button"  value="添加产品"/></a>
                        <div class="page-block">
                        <form action="travelproductseparateServlet" id="frm" method="Post" style="display: inline;">
                                        <div>
                                            <!--从request中提取值-->
                                            <%
                                            try {
			                      ...
			                      ///   recommendNumber,invoice,insurance,startTime,endTime,entertainIntroduction,availableState;
                                          ...
                                          //输出currentPage , count , pageCount , i  ;
                                            ...
                                            %>
                                            <span><a href="travelproductseparateServlet?currentPage=1">[First]</a> </span> 
                                            <span><a href="travelproductseparateServlet?currentPage=<%=currentPage - 1%>">[L]</a> </span>
                                            <%
				                            }
                                            ...
                                            %>
                                            <span><a href="travelproductseparateServlet?currentPage=<%=i%>"><%=i%></a>
                                            </span>
                                            <%
                                                }
                                                }
                                            ...
                                            %>
                                            <span><a
                                                href="travelproductseparateServlet?currentPage=<%=currentPage + 1%>">[>]</a> </span> <span><a
                                                href="travelproductseparateServlet?currentPage=<%=pageCount%>">[FINAL]</a> </span>
                                            <%
                                                }
                                            %>
