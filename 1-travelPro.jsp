                ...
                <div class="page-block">
                    <div class="product-list">
                        <div id="mrestaurant" class="product-restaurant">              
                                    <div class="box">
                                        <form action="modifytravelproductServlet" method="post">
                                            ...
                                            <div class="form-group">
                                                <label>项目类型</label>
                                                <input type="text" class="form-control" name="travelType"/>
                                            </div>
                                            <div class="form-group">
                                                <label>平日价格</label>
                                                <input type="text" class="form-control" name="travelPrice"/>
                                            </div>
                                            <div class="form-group">
                                                <label>周末价格</label>
                                            ...
                                            <div class="form-group">
                                                <label>会员价格</label>
                                                <input type="text" class="form-control" name="travelMemberPrice"/>
                                            </div>
                                            <div class="form-group">
                                                <label>项目时长</label>
                                                <input type="text" class="form-control" name="travelTime"/>
                                            </div>
                                            <div class="form-group">
                                                <label>项目场地</label>
                                                <input type="text" class="form-control" name="travelPlace"/>
                                            </div>
                                            <div class="form-group">
                                                <label>预约信息</label>
                                            ...
                                            <div class="form-group">
                                                <label>项目简介</label>
                                                <input type="text" class="form-control" name="travelIntroduction"/>
                                            </div>
                                            <div class="form-group">
                                                <label>库存数量</label>
