...
<!DOCTYPE html>
    ...
    <a href="admin-news.jsp"><li class="nav-item"><i class="icon-user"></i><span> 会员消息</span></li></a>
    <a href="#"  class="mActive"> <li class="nav-item" id="info"><i class="icon-shopping-cart"></i><span> 商家消息</span><span class="badge">new</span></li></a>
    </div>
    <div class="block">
    ...
    <script src="js/admin-news-ajax2.js"></script>
    </body>
    </html>
