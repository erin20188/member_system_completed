                ...
                <div class="page-block">
                    <div class="product-list">
                        <div id="mrestaurant" class="product-restaurant">             
                                <div>
                                    <div class="box">
                                        <form action="modifyentertainproductServlet" method="post">
                                            ...
                                            <div class="form-group">
                                                <label>项目名称</label>
                                                <input type="text" class="form-control" name="entertainName"/>
                                            </div>
                                            <div class="form-group">
                                                <label>项目类型</label>
                                                <input type="text" class="form-control" name="entertainType"/>
                                            </div>
                                            <div class="form-group">
                                                <label>平日价格</label>
                                                <input type="text" class="form-control" name="entertainPrice"/>
                                            </div>
                                            <div class="form-group">
                                                <label>周末价格</label>
                                            ...
                                            <div class="form-group">
                                                <label>会员价格</label>
                                                <input type="text" class="form-control" name="entertainMemberPrice"/>
                                            </div>
                                            <div class="form-group">
                                                <label>项目时长</label>
                                                <input type="text" class="form-control" name="entertainTime"/>
                                            </div>
                                            <div class="form-group">
                                                <label>项目场地</label>
                                                <input type="text" class="form-control" name="entertainPlace"/>
                                            </div>
                                            <div class="form-group">
                                                <label>预约信息</label>
                                                <input type="text" class="form-control" name="reservationInformation"/>
                                            </div>
                                            <div class="form-group">
                                                <label>推荐人数</label>
                                                <input type="text" class="form-control" name="recommendNumber"/>
                                            </div>
                                            <div class="form-group">
                                                <label>项目简介</label>
                                                <input type="text" class="form-control" name="entertainIntroduction"/>
                                            </div>
                                            <div class="form-group">
                                                <label>库存数量</label>
